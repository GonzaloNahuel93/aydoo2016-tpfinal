...
describe 'Integracion_De_Colisiones' do
  ...
  it 'Se verifica que la colision Nave-Asteroide se lleve a cabo de manera correcta' do
    ...
    expect(asteroide.masa).to eq 310
  end
  ...
  it 'Se verifica que la colision Estrella-Misil se lleve a cabo de manera correcta' do
    estrella = Estrella.new(1000,1000)
    misil = Misil.new(50,50)
    ...
    expect(misil.masa).to eq 50
  end

  it 'Se verifica que la colision Estrella-Bomba se lleve a cabo de manera correcta' do
    estrella = Estrella.new(500,500)
    bomba = Bomba.new(250,250)

    estrella.colisionar_con(bomba)
  ...
  it 'Se verifica que la colision Estrella-Asteroide se lleve a cabo de manera correcta' do
    estrella = Estrella.new(2000,2000)
    asteroide = Asteroide.new(500,500)

    estrella.colisionar_con(asteroide)

    #Vida & Masa de la estrella
    expect(estrella.vida).to eq 0
    expect(estrella.masa).to eq 2000

    #Vida & Masa del asteroide
    expect(asteroide.vida).to eq 500
